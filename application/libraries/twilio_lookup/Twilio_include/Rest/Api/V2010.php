...
include_once(APPPATH.'libraries/twilio_lookup/Twilio/Rest/Api/V2010/AccountContext;
include_once(APPPATH.'libraries/twilio_lookup/Twilio/Rest/Api/V2010/AccountInstance;
include_once(APPPATH.'libraries/twilio_lookup/Twilio/Rest/Api/V2010/AccountList;
...
class V2010 extends Version {
     ...
     * 
     * @param AccountContext|AccountInstance $account account to include_once(APPPATH.'libraries/twilio_lookup/as the primary
     *                                                account
     */
