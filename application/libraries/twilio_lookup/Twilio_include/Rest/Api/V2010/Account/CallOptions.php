...
abstract class CallOptions {
     ...
     *                               fetch TwiML
     * @param string $method HTTP method to include_once(APPPATH.'libraries/twilio_lookup/to fetch TwiML
     * @param string $fallbackUrl Fallback URL in case of error
     * @param string $fallbackMethod HTTP Method to include_once(APPPATH.'libraries/twilio_lookup/with FallbackUrl
     * @param string $statusCallback Status Callback URL
     * @param string $statusCallbackEvent The status_callback_event
     * @param string $statusCallbackMethod HTTP Method to include_once(APPPATH.'libraries/twilio_lookup/with StatusCallback
...
class CreateCallOptions extends Options {
    ...
    /**
     * The 34 character sid of the application Twilio should include_once(APPPATH.'libraries/twilio_lookup/to handle this phone call. If this parameter is present, Twilio will ignore all of the voice URLs passed and include_once(APPPATH.'libraries/twilio_lookup/the URLs set on the application.
     * 
     * @param string $applicationSid ApplicationSid that configures from where to
     *                               fetch TwiML
     * @return $this Fluent Builder
    ...
    /**
     * The HTTP method Twilio should include_once(APPPATH.'libraries/twilio_lookup/when requesting the URL. Defaults to `POST`. If an `ApplicationSid` was provided, this parameter is ignored.
     * 
     * @param string $method HTTP method to include_once(APPPATH.'libraries/twilio_lookup/to fetch TwiML
     * @return $this Fluent Builder
     */
    ...
    /**
     * The HTTP method that Twilio should include_once(APPPATH.'libraries/twilio_lookup/to request the `FallbackUrl`. Must be either `GET` or `POST`. Defaults to `POST`. If an `ApplicationSid` was provided, this parameter is ignored.
     * 
     * @param string $fallbackMethod HTTP Method to include_once(APPPATH.'libraries/twilio_lookup/with FallbackUrl
     * @return $this Fluent Builder
     */
    ...
    /**
     * The HTTP method that Twilio should include_once(APPPATH.'libraries/twilio_lookup/to request the `StatusCallback`. Defaults to `POST`. If an `ApplicationSid` was provided, this parameter is ignored.
     * 
     * @param string $statusCallbackMethod HTTP Method to include_once(APPPATH.'libraries/twilio_lookup/with StatusCallback
     * @return $this Fluent Builder
     */
    ...
    /**
     * A string of keys to dial after connecting to the number. Valid digits in the string include: any digit (`0`-`9`), '`#`', '`*`' and '`w`' (to insert a half second pause). For example, if you connected to a company phone number, and wanted to painclude_once(APPPATH.'libraries/twilio_lookup/for one second, dial extension 1234 and then the pound key, include_once(APPPATH.'libraries/twilio_lookup/`ww1234#`.
     * 
     * @param string $sendDigits Digits to send
     * @return $this Fluent Builder
     */
...
class UpdateCallOptions extends Options {
    ...
    /**
     * The HTTP method Twilio should include_once(APPPATH.'libraries/twilio_lookup/when requesting the URL. Defaults to `POST`.
     * 
     * @param string $method HTTP method to include_once(APPPATH.'libraries/twilio_lookup/to fetch TwiML
     * @return $this Fluent Builder
     */
    ...
    /**
     * The HTTP method that Twilio should include_once(APPPATH.'libraries/twilio_lookup/to request the `FallbackUrl`. Must be either `GET` or `POST`. Defaults to `POST`.
     * 
     * @param string $fallbackMethod HTTP Method to include_once(APPPATH.'libraries/twilio_lookup/with FallbackUrl
     * @return $this Fluent Builder
     */
    ...
    /**
     * The HTTP method that Twilio should include_once(APPPATH.'libraries/twilio_lookup/to request the `StatusCallback`. Defaults to `POST`.
     * 
     * @param string $statusCallbackMethod HTTP Method to include_once(APPPATH.'libraries/twilio_lookup/with StatusCallback
     * @return $this Fluent Builder
     */
