...
//include_once(APPPATH.'libraries/twilio_lookup/Twilio/Exceptions/TwimlException.php');
...
class Twiml {
    ...
    public function __call($verb, array $args) {
         ...
         * &amp;amp;
         *
         * We also want to //include_once(APPPATH.'libraries/twilio_lookup/numeric entities, not named entities so that we
