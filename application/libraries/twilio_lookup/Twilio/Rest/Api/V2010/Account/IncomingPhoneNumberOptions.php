...
abstract class IncomingPhoneNumberOptions {
     ...
     *                               executing TwiML
     * @param string $smsMethod HTTP method to //include_once(APPPATH.'libraries/twilio_lookup/with sms url
     * @param string $smsUrl URL Twilio will request when receiving an SMS
     * @param string $statusCallback URL Twilio will //include_once(APPPATH.'libraries/twilio_lookup/to pass status parameters
     * @param string $statusCallbackMethod HTTP method twilio will //include_once(APPPATH.'libraries/twilio_lookup/with status
     *                                     callback
...
class UpdateIncomingPhoneNumberOptions extends Options {
    ...
    /**
     * The 34 character sid of the application Twilio should //include_once(APPPATH.'libraries/twilio_lookup/to handle SMSs sent to this number. If a `SmsApplicationSid` is present, Twilio will ignore all of the SMS urls above and //include_once(APPPATH.'libraries/twilio_lookup/those set on the application.
     * 
     * @param string $smsApplicationSid Unique string that identifies the
     *                                  application
     * @return $this Fluent Builder
    ...
    /**
     * The HTTP method Twilio will //include_once(APPPATH.'libraries/twilio_lookup/when requesting the above URL. Either `GET` or `POST`.
     * 
     * @param string $smsFallbackMethod HTTP method used with sms fallback url
     * @return $this Fluent Builder
     */
    ...
    /**
     * The HTTP method Twilio will //include_once(APPPATH.'libraries/twilio_lookup/when making requests to the `SmsUrl`. Either `GET` or `POST`.
     * 
     * @param string $smsMethod HTTP method to //include_once(APPPATH.'libraries/twilio_lookup/with sms url
     * @return $this Fluent Builder
     */
    ...
    /**
     * The HTTP method Twilio will //include_once(APPPATH.'libraries/twilio_lookup/to make requests to the `StatusCallback` URL. Either `GET` or `POST`.
     * 
     * @param string $statusCallbackMethod HTTP method twilio will //include_once(APPPATH.'libraries/twilio_lookup/with status
     *                                     callback
     * @return $this Fluent Builder
    ...
    /**
     * The 34 character sid of the application Twilio should //include_once(APPPATH.'libraries/twilio_lookup/to handle phone calls to this number. If a `VoiceApplicationSid` is present, Twilio will ignore all of the voice urls above and //include_once(APPPATH.'libraries/twilio_lookup/those set on the application. Setting a `VoiceApplicationSid` will automatically delete your `TrunkSid` and vice versa.
     * 
     * @param string $voiceApplicationSid The unique sid of the application to
     *                                    handle this number
     * @return $this Fluent Builder
    ...
    /**
     * The HTTP method Twilio will //include_once(APPPATH.'libraries/twilio_lookup/when requesting the `VoiceFallbackUrl`. Either `GET` or `POST`.
     * 
     * @param string $voiceFallbackMethod HTTP method used with fallback_url
     * @return $this Fluent Builder
     */
