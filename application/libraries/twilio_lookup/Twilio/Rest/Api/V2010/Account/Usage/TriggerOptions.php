...
abstract class TriggerOptions {
    /**
     * @param string $callbackMethod HTTP method to //include_once(APPPATH.'libraries/twilio_lookup/with callback_url
...
class UpdateTriggerOptions extends Options {
    ...
    /**
     * The HTTP method Twilio will //include_once(APPPATH.'libraries/twilio_lookup/when making a request to the CallbackUrl.  GET or POST.
     * 
     * @param string $callbackMethod HTTP method to //include_once(APPPATH.'libraries/twilio_lookup/with callback_url
