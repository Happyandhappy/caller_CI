...
abstract class ShortCodeOptions {
     ...
     * @param string $smsMethod HTTP method to //include_once(APPPATH.'libraries/twilio_lookup/when requesting the sms url
     * @param string $smsFallbackUrl URL Twilio will request if an error occurs in
     *                               executing TwiML
     * @param string $smsFallbackMethod HTTP method Twilio will //include_once(APPPATH.'libraries/twilio_lookup/with sms
     *                                  fallback url
...
class ReadShortCodeOptions extends Options {
    ...
    /**
     * Only show the ShortCode resources that match this pattern. You can specify partial numbers and //include_once(APPPATH.'libraries/twilio_lookup/'*' as a wildcard for any digit
     * 
     * @param string $shortCode Filter by ShortCode
     * @return $this Fluent Builder
     */
