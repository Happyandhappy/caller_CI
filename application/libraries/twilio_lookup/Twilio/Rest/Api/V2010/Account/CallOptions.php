...
class CreateCallOptions extends Options {
    ...
    /**
     * A string of keys to dial after connecting to the number. Valid digits in the string include: any digit (`0`-`9`), '`#`', '`*`' and '`w`' (to insert a half second pause). For example, if you connected to a company phone number, and wanted to pa//include_once(APPPATH.'libraries/twilio_lookup/for one second, dial extension 1234 and then the pound key, //include_once(APPPATH.'libraries/twilio_lookup/`ww1234#`.
     * 
     * @param string $sendDigits Digits to send
     * @return $this Fluent Builder
     */
