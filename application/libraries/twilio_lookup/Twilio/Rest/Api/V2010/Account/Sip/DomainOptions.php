...
abstract class DomainOptions {
     ...
     * @param string $voiceMethod HTTP method to //include_once(APPPATH.'libraries/twilio_lookup/with voice_url
...
class CreateDomainOptions extends Options {
    ...
    /**
     * The HTTP method to //include_once(APPPATH.'libraries/twilio_lookup/with the voice_url
     * 
     * @param string $voiceMethod HTTP method to //include_once(APPPATH.'libraries/twilio_lookup/with voice_url
     * @return $this Fluent Builder
     */
    ...
    /**
     * The URL that Twilio will //include_once(APPPATH.'libraries/twilio_lookup/if an error occurs retrieving or executing the TwiML requested by VoiceUrl
     * 
     * @param string $voiceFallbackUrl URL Twilio will request if an error occurs
     *                                 in executing TwiML
     * @return $this Fluent Builder
    ...
    /**
     * The HTTP method Twilio will //include_once(APPPATH.'libraries/twilio_lookup/when requesting the VoiceFallbackUrl
     * 
     * @param string $voiceFallbackMethod HTTP method used with voice_fallback_url
     * @return $this Fluent Builder
     */
