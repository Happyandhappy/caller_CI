...
abstract class ApplicationOptions {
     ...
     *                         call
     * @param string $voiceMethod HTTP method to //include_once(APPPATH.'libraries/twilio_lookup/with the URL
     * @param string $voiceFallbackUrl Fallback URL
     * @param string $voiceFallbackMethod HTTP method to //include_once(APPPATH.'libraries/twilio_lookup/with the fallback url
     * @param string $statusCallback URL to hit with status updates
     * @param string $statusCallbackMethod HTTP method to //include_once(APPPATH.'libraries/twilio_lookup/with the status
     *                                     callback
     * @param string $voiceCallerIdLookup True or False
     * @param string $smsUrl URL Twilio will request when receiving an SMS
     * @param string $smsMethod HTTP method to //include_once(APPPATH.'libraries/twilio_lookup/with sms_url
     * @param string $smsFallbackUrl Fallback URL if there's an error parsing TwiML
     * @param string $smsFallbackMethod HTTP method to //include_once(APPPATH.'libraries/twilio_lookup/with sms_fallback_method
...
class CreateApplicationOptions extends Options {
    ...
    /**
     * Twilio will make a `POST` request to this URL to pass status parameters (such as sent or failed) to your application if you //include_once(APPPATH.'libraries/twilio_lookup/the `/Messages` endpoint to send the message and specify this application's `Sid` as the `ApplicationSid` on an outgoing SMS request.
     * 
     * @param string $messageStatusCallback URL to make requests to with status
     *                                      updates
     * @return $this Fluent Builder
