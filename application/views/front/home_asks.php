		...
		<?php } ?>
		 <div class="travelo-box box-full">
			<div class="contact-form">
				<form method="post" id="fmask" action="<?php echo base_url();?>index.php?asks/advice">
					<div class="row">
						<div class="col-sm-10">
		...
		<div class="travelo-box box-full">
			<div class="contact-form">
				<div class="row">
					<div class="col-sm-5">
						<div class="form-group">
							<label>Read the latest questions and answers from our community</label>
								<select class="input-text full-width" name="category_id" id="category_id" onchange="get_expert(this.value);">
									<option selected="selected" value="">Trades</option>
									<?php $this->db->order_by('category_id', 'asc');
									$test = $this->db->get('tbl_category')->result_array();
									foreach($test as $res){ ?>
			...
			<div class="row image-box hotel listing-style1" id="expert">
				<?php $review = $this->crud_model->get_records('tbl_expertreview');
				foreach($review as $res) { ?>
					<div class="col-sm-6 col-md-4">
                        <article class="box">
							<div class="details">
                                <h4 class="box-title"><?php echo $res['title'] ?></h4>
                                <p class="description"><?php echo $string = substr($res['review'], 0, 100);?></p>
                                <div class="action">
