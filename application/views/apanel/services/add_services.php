...
<form class="form-horizontal form-bordered" data-parsley-validate="true"  action="<?php echo base_url(); ?>apanel/services_add" name="demo-form" novalidate="" method="post" enctype="multipart/form-data">
  ...
  <div class="panel-body panel-form">
		  ...
		  <div class="form-group">
			...
			<div class="col-md-6 col-sm-6">
			  <input class="form-control" id="question" name="question" maxlength="100" value="<?php echo set_value('question')?>" placeholder="<?php echo get_phrase('Title')?>" data-parsley-required="true" data-parsley-type="text" type="text">
	...
	<div class="form-group">
		...
		<div class="col-md-10">
			...
			<div class="panel panel-inverse" data-sortable-id="form-wysiwyg-1">
				...
				<div class="panel-body panel-form">
					<textarea class="ckeditor" id="answer" name="answer" rows="20"  placeholder="<?php echo get_phrase('Answer')?>" data-parsley-required="true" data-parsley-type="text" ><?php echo set_value('answer')?></textarea>
