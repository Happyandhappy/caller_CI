...
<div class="row-fluid sortable">		
	  ...
	  <?php } ?>
					...
					<div class="box-content">
                     <a href="<?php echo base_url()?>apanel/services_add/">
        ...
        $test = $this->db->get('tbl_services')->result_array();
        $caounter=0;
        foreach ($test as $row):$caounter++;?>
            <tr>
              ...
              <td><?php if($row['status']=='1'){ echo "Active"; }
				  ...
				  ?></td>
              <td style="width:200px"><a href="<?php echo base_url().'apanel/services_edit/'.$row['services_id']; ?>">
                <button class="btn btn-primary"> Update</button>
                </a> <a href="<?php echo base_url().'apanel/services/delete/'. $row['services_id']; ?>">
