...
$data = $this->db->get('tbl_team')->row();
?>

<form class="form-horizontal form-bordered" data-parsley-validate="true"  action="<?php echo base_url(); ?>apanel/team_edit/<?php echo $data->team_id?>" name="demo-form" novalidate="" method="post" enctype="multipart/form-data">
			...
			<label class="control-label col-md-2 col-sm-4" for="email"><?php echo get_phrase('Upload Picture')?> * :</label>
				<div class="col-md-6 col-sm-6">
                      <div class="fileinput-new thumbnail" style="width: 200px; height: 200px;" data-trigger="fileinput">
                          <img src="<?php echo base_url();?>uploads/team_img/<?php echo $data->image?>" alt="...">
                      </div>
                      <div>
