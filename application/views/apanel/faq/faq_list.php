...
<div class="row-fluid sortable">		
	  ...
	  <?php } if($this->session->flashdata('error')){ ?>
		<div class="alert alert-v fade in">
            <button type="button" class="close" data-dismiss="alert">
                <span aria-hidden="true">×</span>
            </button>
	  ...
	  <?php } ?>
					...
					<div class="box-content">
                     <a href="<?php echo base_url()?>apanel/faq_add/">
        ...
        $test = $this->db->get('tbl_faq')->result_array();
        $caounter=0;
        foreach ($test as $row):$caounter++;?>
            <tr>
              ...
              <td><?php if($row['status']=='1'){ echo "Active"; }
				  ...
				  ?></td>
              <td style="width:200px"><a href="<?php echo base_url().'apanel/faq_edit/'.$row['faq_id']; ?>">
                <button class="btn btn-primary"> Update</button>
                </a> <a href="<?php echo base_url().'apanel/faq/delete/'. $row['faq_id']; ?>">
