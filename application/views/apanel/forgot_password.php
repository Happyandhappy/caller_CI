...
<html lang="en">
	...
	<div id="page-container" class="fade">
        ...
        <div class="login login-v2" data-pageload-addclass="animated fadeIn">
			...
			<?php } ?>
                <form action="<?php echo base_url()?>apanel/forgot_password"  id="form_login"  method="POST" class="margin-bottom-0" data-parsley-validate="true">
                    ...
                    <div class="login-buttons">
                        <button type="submit" name="btn_forgot" class="btn btn-success btn-block btn-lg">Submit</button>
                    </div>
                </form>
            </div>
        </div>
